...
[![Header](https://capsule-render.vercel.app/api?type=venom&color=0:1a1a2e,50:FF6D5A,100:EA4B35&height=250&section=header&text=cudhna&fontFace=Lobster&fontSize=90&fontAlignY=35&desc=Automation%20Engineer%20%7C%20Workflow%20Architect&descSize=22&descAlignY=62&fontColor=ffffff&animation=twinkling&stroke=000000&strokeWidth=0)](https://github.com/cudhna)

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=600&color=FF6D5A&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=130&lines=🔗+Connecting+nodes+since+day+one...;⚡+n8n+%7C+Power+Automate+%7C+Make+(Integromat);🤖+If+this+→+Then+that+→+Profit;🌐+Automating+the+boring+stuff)](https://git.io/typing-svg)
...
```json
{
  ...
  "parameters": {
    "name": "cudhna",
    "location": "Viet Nam 🇻🇳",
    "role": "Automation Engineer & Workflow Builder",
    "tools": ["n8n", "Power Automate", "Make (Integromat)"],
    "focus": ["No-code / Low-code", "API Integration", "Process Automation"],
...
### 💻 Code & Backend
[![My Skills](https://skillicons.dev/icons?i=js,ts,python,nodejs,express&theme=dark&perline=10)](https://skillicons.dev)

### 🗄️ Databases & Cloud
[![My Skills](https://skillicons.dev/icons?i=mongodb,postgres,mysql,redis,docker,git&theme=dark&perline=10)](https://skillicons.dev)

### 🔧 Tools
[![My Skills](https://skillicons.dev/icons?i=vscode,postman,github,linux&theme=dark&perline=10)](https://skillicons.dev)
...
[![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:EA4B35,100:1a1a2e&height=120&section=footer&desc=Built%20with%20automation%20%26%20too%20much%20coffee%20☕&descSize=18&descAlignY=55&fontColor=ffffff)](https://github.com/cudhna)
